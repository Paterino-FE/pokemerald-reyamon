...
#define FLAG_SHOWN_BIRTHDAY_TICKET           0x1DE // Unused Flag
...
#define FLAG_UNUSED_0x264                                     0x264 // this is actually used somewhere....
#define FLAG_HIDDEN_ITEM_SSLANNN_START_BITS_OF_TRASH          0x265
#define FLAG_HIDDEN_ITEM_SSLANNN_LOWER_ROCKY_HELMET           0x266 
#define FLAG_HIDDEN_ITEM_SSLANNN_CAPTAIN_SMOOTH_ROCK          0x267 
#define FLAG_HIDDEN_ITEM_SSLANNN_KITCHEN_SLUDGE_BOMB          0x268
...
#define FLAG_HIDE_MAKUHITA                                          0x493 
#define FLAG_HIDE_CROAGUNK                                          0x494 
...
#define FLAG_HIDE_CHAMP_VYRAL                                       0x499 // Unused Flag
#define FLAG_HIDE_TRASH                                             0x49A // Unused Flag
#define FLAG_HIDE_THEA                                              0x49B // Unused Flag
#define FLAG_TALKED_TO_THEA                                         0x49C // Unused Flag
...
#define FLAG_WON_ROCKPAPERSCISSORS                                  0x4A3 // Unused Flag
#define FLAG_TALKED_TO_ATSUI                                        0x4A4 // Unused Flag
#define FLAG_HIDE_FUTURE                                            0x4A5 // Unused Flag
#define FLAG_HIDE_PRESENT                                           0x4A6 // Unused Flag
#define FLAG_HIDE_PAT_HAMLET                                        0x4A7 // Unused Flag
#define FLAG_HIDE_THEA_HAMLET                                       0x4A8 // Unused Flag
#define FLAG_HIDE_SNORLAX                                           0x4A9 // Unused Flag
...
#define FLAG_GIVEN_AIR_BALLOON                                      0x4E9 // Unused Flag
#define FLAG_TALKED_HATZOOME_LANNN                                  0x4EA // Unused Flag
#define FLAG_TALKED_HATZOOME_PRESENT                                0x4EB // Unused Flag
#define FLAG_TALKED_HATZOOME_ENDING                                 0x4EC // Unused Flag
#define FLAG_HIDE_HATZOOME_ENDING                                   0x4ED // Unused Flag
...
#define FLAG_BEATEN_VICTORY_ROAD                    (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_BEATEN_ELITE_ARLECCHINO                (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_BEATEN_ELITE_ASTARION                  (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_BEATEN_ELITE_CYNTHIA                   (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_BEATEN_ELITE_SATSUKI                   (SYSTEM_FLAGS + 0x89) // Unused Flag
#define FLAG_ENABLE_BIRTHDAY_ISLAND                 (SYSTEM_FLAGS + 0x8A) // Unused Flag
#define FLAG_TALKED_TO_LUMI_BOAT                    (SYSTEM_FLAGS + 0x8B) // Unused Flag
