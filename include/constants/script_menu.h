...
#define MULTI_LIAM_GAME_CORNER_TMS         115
#define MULTI_ROTOM_FORMS                  116
#define MULTI_ROCK_PAPER_SCISSORS          117
#define MULTI_GO_WITH_LILYPAD              118
...
#define SSTIDAL_SELECTION_BIRTHDAY_ISLAND  6
