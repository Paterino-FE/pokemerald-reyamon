...
const u16 gMetatiles_birthdayisland[] = INCBIN_U16("data/tilesets/secondary/birthdayisland/metatiles.bin");
const u16 gMetatileAttributes_birthdayisland[] = INCBIN_U16("data/tilesets/secondary/birthdayisland/metatile_attributes.bin");
