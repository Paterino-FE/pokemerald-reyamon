...
static const struct HealLocation sHealLocationsPokemonCenter[HEAL_LOCATION_COUNT - 1] =
{
    ...
    [HEAL_LOCATION_BIRTHDAY_ISLAND_MAIN_VILLAGE - 1] =
    {
        .group = MAP_GROUP(BIRTHDAY_POKEMON_CENTER),
        .map = MAP_NUM(BIRTHDAY_POKEMON_CENTER),
        .x  = 6,
        .y = 4,
    },
};
...
static const u8 sHealNpcLocalId[HEAL_LOCATION_COUNT - 1] =
{
    ...
    [HEAL_LOCATION_BIRTHDAY_ISLAND_MAIN_VILLAGE - 1] = 1,
};
