...
static const u32 sMugshotImg_Arle[] = INCBIN_U32("graphics/mugshots/elite_four_sydney.4bpp.lz");
static const u16 sMugshotPal_Arle[] = INCBIN_U16("graphics/mugshots/elite_four_sydney.gbapal");
