...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TEAM_AQUA] = { _("TENTACOOL") },
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = { _("DRAGON GANG") },
    [TRAINER_CLASS_TEAM_ROCKET] = { _("TEAM ROCKET") },
    [TRAINER_CLASS_BURGLAR] = { _("BURGLAR") },
    [TRAINER_CLASS_FRIEREN] = { _("GREAT MAGE") },
    [TRAINER_CLASS_EMILIA] = { _("SERVANT"), 0 },
    [TRAINER_CLASS_DIRKLING] = { _("DIRKLING"), 10 },
    ...
    [TRAINER_CLASS_ROSUURI] = { _("WHITE RABBIT"), 15 },
    [TRAINER_CLASS_PURGE] = { _("WEATHER MAN"), 15 },
    [TRAINER_CLASS_TSUNAMI] = { _("TALENT"), 15 },
    [TRAINER_CLASS_KING_VYRAL] = { _("KING"), 20, BALL_LUXURY },
    [TRAINER_CLASS_IMPOSTOR] = { _("SUS"), 20 },
    [TRAINER_CLASS_ARTIST] = { _("PIXEL-ARTIST"), 10},
    ...
    [TRAINER_CLASS_AQUA_LEADER] = { _("GIRL FAILURE"), 20, BALL_MASTER },
