...
static const u8 sText_Lanettes[] = _("FORTY's"); //no decapitalize until it is everywhere
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_DONTLEAVEBIRCH]                       = COMPOUND_STRING("PROF. PAT: Don't leave me like this!\p"), //no decapitalize until it is everywhere
...
const u8 gText_BattleWallyName[] = _("LILYPAD");
...
static const u8 sText_TwoTrainersWantToBattle[] = _("Challenge by {B_TRAINER1_NAME_WITH_CLASS} and {B_TRAINER2_NAME_WITH_CLASS}!\p");
