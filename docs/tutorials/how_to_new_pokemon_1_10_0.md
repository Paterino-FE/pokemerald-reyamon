...
![mGBA_6WOo1TSlsn](https://github.com/Paterino-FE/pokemerald-reyamonassets/2904965/0c625cd8-8f89-4bc8-a285-b10a420a8f6d)
...
![image](https://github.com/Paterino-FE/pokemerald-reyamonassets/2904965/dc15b0ba-a4bd-4f4e-9658-2dff73a11f79)
...
Let's add the cry to the ROM via [sound/direct_sound_data.inc](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/sound/direct_sound_data.inc).
...
Then we add the cry ID to [include/constants/cries.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/include/constants/cries.h):
...
And then link it in [sound/cry_tables.inc](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/sound/cry_tables.inc). `cry_reverse` in particular is for reversed cries used by moves such as Growl. The order of these two tables should match the order of the cry IDs, otherwise they'll be shifted.
...
https://github.com/Paterino-FE/pokemerald-reyamonassets/2904965/4f7667db-4db9-4bfd-a8dd-ece26f09f327
...
```
![image](https://github.com/Paterino-FE/pokemerald-reyamonassets/2904965/3759dd4c-8da5-4b1c-9a50-b9e9d0815e7f)
...
```
![mGBA_lUBfmFEKUx](https://github.com/Paterino-FE/pokemerald-reyamonassets/2904965/3a8b8a17-759b-486b-9831-deb2f494bd71)
...
- `frontAnimId`:
    - Because you are limited to two frames, there are already [predefined front sprite animations](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/include/pokemon_animation.h), describing translations, rotations, scalings or color changes.
- `frontAnimDelay`:
...
- `backAnimId`:
    - Like `frontAnimId` except for the back sprites and them being a single frame. The IDs listed [here](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/include/pokemon_animation.h) are used to represent 3 different animations that happen based on the the Pokémon's nature.
- `palette`:
...
Append to [src/data/pokemon/level_up_learnsets/gen_9.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon/level_up_learnsets/gen_9.h):
...
![image](https://github.com/Paterino-FE/pokemerald-reyamonassets/2904965/a1a90b79-46a1-4cd6-97d6-ec5d741bfdc8) ![image](https://github.com/Paterino-FE/pokemerald-reyamonassets/2904965/7cffc6be-0b5c-4074-b689-736a97297843)
...
![mGBA_Wq5cbDkNZG](https://github.com/Paterino-FE/pokemerald-reyamonassets/2904965/45256192-b451-4baa-af06-f57ca16e1e46)
...
## 4. Overworld Data
![mGBA_4iqvhhSltK](https://github.com/Paterino-FE/pokemerald-reyamonassets/2904965/e59238dc-9779-4f26-a9e7-159a32caa3d9)
...
Secondly, in [src/data/graphics/pokemon.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/graphics/pokemon.h), add the following:
...
Thirdly, in [spritesheet_rules.mk](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/spritesheet_rules.mk)
...
Fourthly, in [src/data/object_events/object_event_pic_tables_followers.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/object_events/object_event_pic_tables_followers.h):
```diff
#if P_FAMILY_PECHARUNT
