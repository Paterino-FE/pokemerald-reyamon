...
Edit [src/data/graphics/pokemon.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/graphics/pokemon.h):
...
Edit [src/data/pokemon_graphics/front_pic_anims.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon_graphics/front_pic_anims.h):
...
Edit [src/pokemon.c](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/pokemon.c):
```diff
...
Edit [src/pokemon_animation.c](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/pokemon_animation.c):
...
Edit [src/data/pokemon_graphics/enemy_mon_elevation.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon_graphics/enemy_mon_elevation.h):
...
Edit [src/data/pokemon_graphics/front_pic_table.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon_graphics/front_pic_table.h):
...
Edit [src/data/pokemon_graphics/front_pic_coordinates.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon_graphics/front_pic_coordinates.h):
...
Edit [src/data/pokemon_graphics/back_pic_table.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon_graphics/back_pic_table.h):
...
Edit [src/data/pokemon_graphics/back_pic_coordinates.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon_graphics/back_pic_coordinates.h):
...
Edit [src/data/pokemon_graphics/footprint_table.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon_graphics/footprint_table.h):
...
Edit [src/data/pokemon_graphics/palette_table.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon_graphics/palette_table.h):
...
Edit [src/data/pokemon_graphics/shiny_palette_table.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon_graphics/shiny_palette_table.h):
...
Edit [src/pokemon_icon.c](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/pokemon_icon.c):
...
Edit [include/constants/species.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/include/constants/species.h):
...
Edit [src/data/text/species_names.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/text/species_names.h):
...
Edit [include/constants/pokedex.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/include/constants/pokedex.h):
...
Append to [src/data/pokemon/pokedex_text.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon/pokedex_text.h):
...
Edit [src/data/pokemon/pokedex_entries.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon/pokedex_entries.h):
...
Edit [src/data/pokemon/pokedex_orders.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon/pokedex_orders.h):
...
Edit [src/data/pokemon/species_info.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon/species_info.h):
```diff
...
Notice how I also set the ability to `ABILITY_INSOMNIA`, so our little monster doesn't even need to sleep anymore. You can find the abilities for example here [include/constants/abilities.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/include/constants/abilities.h) and here [src/data/text/abilities.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/text/abilities.h).
...
Append to [src/data/pokemon/level_up_learnsets.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon/level_up_learnsets.h):
...
Edit [src/data/pokemon/level_up_learnset_pointers.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon/level_up_learnset_pointers.h):
...
Append to [src/data/pokemon/teachable_learnsets.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon/teachable_learnsets.h):
...
Edit [src/data/pokemon/teachable_learnset_pointers.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon/teachable_learnset_pointers.h):
...
If you want to create a Pokémon which can breed, you will need to edit [src/data/pokemon/egg_moves.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon/egg_moves.h).
...
In [sound/direct_sound_data.inc](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/sound/direct_sound_data.inc).
...
And linking it in [sound/cry_tables.inc](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/sound/cry_tables.inc). `cry_reverse` in particular is for reversed cries used by moves such as Growl.
...
Mon cries are 10512Hz. Make sure to put the aif file in the directory [sound/direct_sound_samples/cries](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/sound/direct_sound_samples/cries)
...
Edit [src/data/pokemon/evolution.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/pokemon/evolution.h):
...
Edit [src/data/easy_chat/easy_chat_words_by_letter.h](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/easy_chat/easy_chat_words_by_letter.h):
...
Edit [src/data/wild_encounters.json](https://github.com/Paterino-FE/pokemerald-reyamonblob/master/src/data/wild_encounters.json):
